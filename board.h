...
public:
    Board();
    // Aktualizacija
    void update(bool mR, bool mL, bool mRot, bool mJump);
...
private:
    ...
    static const int mSize = mRows*mCols;
    ...
    std::uniform_int_distribution<int> mUniformDist;
    ...
    bool checkSpace(int x, int y, bool rot);
